        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 space-y-3">
          ...
          {examType === 'language' ? (
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-surface-3 border border-line rounded-lg pl-3 pr-9 py-2 text-xs text-text-primary focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/20 transition-all cursor-pointer"
                >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-surface-3 border border-line rounded-lg px-3 py-2 text-xs text-text-primary placeholder:text-text-quaternary focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/20 transition-all"
              />
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-surface-3 border border-line rounded-lg px-3 py-2 text-xs text-text-primary focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/20 transition-all"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-surface-3 border border-line rounded-lg px-3 py-2 text-xs text-text-primary placeholder:text-text-quaternary focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/20 transition-all resize-none"
            />

...
describe('performRefresh', () => {
  ...
  it('user 없는 응답 → setUser 호출 안 됨 (기존 user 유지)', async () => {
    const existing = {
      ...
      role: 'user' as const,
      onboardedAt: null,
      termsAgreedAt: null, aiConsentAt: null, aiConsentVersion: null, onboardedCoinAt: null, signupJobCategories: null, signupOtherText: null, signupSeriesId: null, signupJobTitle: null, sampleCardsDismissedAt: null,
...
describe('handleAuthFailure — 네트워크·5xx 비파괴', () => {
  const keepUser = {
    ...
    signupOtherText: null, signupSeriesId: null, signupJobTitle: null,

...
export function ProfileSettings() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8">
      ...
      <section className="bg-surface-2 border border-white/5 rounded-xl p-5 mb-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={!nickname.trim() || nickname === user?.nickname || nicknameMutation.isPending}
        ...
        <p className="text-xs text-text-muted mt-2">최대 20자</p>
      </section>
      ...
      {/* 계정 탈퇴 */}
      <section className="bg-surface-2 border border-danger/10 rounded-xl p-5">
        <h2 className="text-sm font-semibold text-danger mb-1">계정 탈퇴</h2>
        <p className="text-xs text-text-muted mb-4">탈퇴 시 모든 데이터가 즉시 삭제되며 복구할 수 없습니다.</p>
        <button

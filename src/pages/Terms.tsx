  ...
  return (
    <div className="min-h-screen bg-bg text-text-primary">
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <DocSection title="제7조의3 (이용자 입력 콘텐츠)">
          <p>
            회원은 서비스에 입력하는 콘텐츠(공고 내용, 메모, 파일 등)에 대하여
            적법한 이용 권한을 보유해야 하며, 제3자의 권리를 침해하는 콘텐츠를
            입력해서는 안 됩니다. 운영자는 회원이 입력한 콘텐츠를 해당 회원의
            서비스 이용 목적 범위에서만 처리합니다.
          </p>
        </DocSection>

        ...
        <DocSection title="1. 수집하는 개인정보 항목">
          ...
          <Table
            ...
            rows={[
              ...
              [
                '내 정보 창고 — 자격·이력 (선택)',
                '자격증·어학·상장·학력(학교·전공·성적·본교/분교·주야간·입학 구분·총 이수학점·검정고시 여부)·활동/경험(인턴·프로젝트·동아리 등)·자기소개서 소재·논문 정보(지도교수·연구 분야·논문 제목·요약, 대학원 지원 시)·지원 서류(증명사진·이력서·포트폴리오 파일 또는 링크·경력기술서·학력 항목에 붙이는 성적/졸업증명서·어학 항목에 붙이는 성적표·그 밖의 PDF/이미지 파일)',
                '본인이 직접 입력·업로드 시',
              ],

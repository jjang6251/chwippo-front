      ...
      <section className="border-t border-line py-20">
        <div className="max-w-xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              to="/login"
              className="inline-flex items-center justify-center w-full sm:w-auto bg-brand hover:bg-accent active:bg-accent-hover text-bg font-semibold text-sm px-8 py-3.5 rounded-xl transition-colors shadow-[0_0_24px_rgb(var(--brand)/0.25)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/60 focus-visible:ring-offset-1 focus-visible:ring-offset-bg"
            >
              지금 무료로 시작하기
            </Link>
            {/*
